							...
							<div class="col-md-8">
								<div class="classic-posts">
									<div class="single-item">
										<img src="{{asset('storage/'.$siswa->gambarsis)}}" style="width:770px;height:410px;" alt="">
										<h4>{{ $siswa->judulsis}}</h4>
										<p>{{ $siswa->deskripsisis}}</p>
										<div class="tags-share">
											<div class="tag">
												<i class="fa fa-tags"></i><p>Tags:</p><span><a href="{{ url('siswa-page')}}">siswa</a></span>
											</div>
											<div class="share">
												<div class="second-button">
													<a href="{{ url('siswa-page')}}">Back To Page <i class="fa fa-arrow-left"></i></a>
												</div>
											</div>
										</div>
									</div>
