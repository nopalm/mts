                                ...
                                @foreach($galeri as $p)
									<div class="item col-md-3 col-sm-6 col-xs-12 classromms">
										<div class="thumb-holder">
											<img src="{{asset('storage/'.$p->gambar)}}" style="width: 262px;height:270px; object-fit: cover;" alt="">
											<div class="hover-content">
												<a href="{{ url('gallery/'.$p->id)}}"><i class="fa fa-search"></i></a>
											</div>
										</div>
										<div class="down-content">
											<a href="{{ url('gallery/'.$p->id)}}"><h4>{{ $p->judul }}</h4></a>
											<span>{{ Str::limit($p->deskripsi, 20)}}</span>
											<div class="text-button">
											<a href="{{ url('gallery/'.$p->id) }}">Read More <i class="fa fa-arrow-right"></i></a>
										</div>
										</div>
                                    </div>
                                    @endforeach
