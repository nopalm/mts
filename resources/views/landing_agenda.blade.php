						...
						<div class="inner-header container clearfix">
		                    ...
		                    <nav class="main-navigation text-left hidden-xs hidden-sm">
								<ul>
									...
									<li><a href="{{ url('agenda-page')}}" class="menu">Download</a>
									</li>
							...
							<div class="col-md-6">
								<div class="classic-posts">
									...
									<div class="classic-item">
										<a href="detail"><img class="img-responsive" src="{{asset('storage/'.$p->gambaragenda)}}" style="width: 390px;height:370px; object-fit: cover;" alt=""></a>
										<a href="{{ url('agenda-page/'.$p->id)}}"><h4>{{ $p->judulagenda}}</h4></a>
										<p>{{ Str::limit($p->deskripsiagenda, 52)}}</p>
										<div class="buttons">
											<div class="accent-button">
												<a href="{{ url('agenda-page/'.$p->id)}}">Continue Reading<i class="fa fa-arrow-right"></i></a>
											</div>
										</div>
                                    </div>
