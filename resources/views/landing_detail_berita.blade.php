							...
							<div class="col-md-8">
								<div class="classic-posts">
									<div class="single-item">
										<img src="{{asset('storage/'.$berita->gambarber)}}"  alt="">
										<h4>{{ $berita->judulber}}</h4>
										<p>{{ $berita->deskripsiber}}</p>
										<div class="tags-share">
											<div class="tag">
												<i class="fa fa-tags"></i><p>Tags:</p><span><a href="{{ url('berita-page')}}">Berita</a></span>
											</div>
											<div class="share">
												<div class="second-button">
													<a href="{{ url('berita-page')}}">Back To Page <i class="fa fa-arrow-left"></i></a>
												</div>
											</div>
										</div>
									</div>
