							...
							<div class="col-md-8">
								<div class="classic-posts">
									<div class="single-item">
										<img src="{{asset('storage/'.$agenda->gambaragenda)}}"  alt="">
										<h4>{{ $agenda->judulagenda}}</h4>
										<p>{{ $agenda->deskripsiagenda}}</p>
										<div class="tags-share">
											<div class="tag">
												<i class="fa fa-tags"></i><p>Tags:</p><span><a href="{{ url('agenda-page')}}">Agenda</a></span>
											</div>
											<div class="share">
												<div class="second-button">
													<a href="{{ url('agenda-page')}}">Back To Page <i class="fa fa-arrow-left"></i></a>
												</div>
											</div>
										</div>
									</div>
