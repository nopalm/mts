							...
							<div class="col-md-12">
								<div class="classic-posts">
									<div class="single-item">
										<img src="{{asset('storage/'.$pengumuman->gambarpeng)}}"   alt="">
										<h4>{{ $pengumuman->judulpeng}}</h4>
										<p>{{ $pengumuman->deskripsipeng }}</p>
										<div class="tags-share">
											<div class="tag">
												<i class="fa fa-tags"></i><p>Tags:</p><span><a href="{{ url('pengumuman-page')}}">pengumuman</a></span>
											</div>
											<div class="share">
												<div class="second-button">
													<a href="{{ url('pengumuman-page')}}">Back To Page <i class="fa fa-arrow-left"></i></a>
												</div>
											</div>
										</div>
									</div>
