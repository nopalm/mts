				...
				<div class="page-heading news-heading">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<h1>Berita</h1>
								<span>Berita terkini dari sekolah</span>
								<div class="page-list">
									<ul>
							...
							<div class="col-md-6">
								<div class="classic-posts">
									...
									<div class="classic-item">
										<a href="{{ url('berita-page/'.$p->id)}}"><img class="img-responsive" src="{{asset('storage/'.$p->gambarber)}}" style="width: 370px;height:370px; object-fit: cover;" alt=""></a>
										<a href="{{ url('berita-page/'.$p->id)}}"><h4>{{ $p->judulber}}</h4></a>
										<!-- <p>{{ $p->deskripsiber}}</p> -->
										<p>{{ Str::limit($p->deskripsiber, 55)}}</p>
										<div class="buttons">
											<div class="accent-button">
												<a href="{{ url('berita-page/'.$p->id)}}">Continue Reading<i class="fa fa-arrow-right"></i></a>
											</div>
										</div>
                                    </div>
