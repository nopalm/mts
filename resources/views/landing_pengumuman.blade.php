				...
				<div class="page-heading news-heading">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
								<h1>Pengumuman</h1>
								<span>Pengumuman terkini tentang sekolah</span>
								<div class="page-list">
									<ul>
										<li class="active"><a href="./">Home</a></li>
										<li><i class="fa fa-angle-right"></i></li>
										<li><a href="{{ url('berita-page')}}">Pengumuman</a></li>
									</ul>
								</div>
							</div>	
						</div>
							...
							<div class="col-md-6">
								<div class="classic-posts">
									...
									<div class="classic-item">
										<a href="{{ url('pengumuman-page/'.$p->id)}}"><img class="img-responsive" src="{{asset('storage/'.$p->gambarpeng)}}" style="width: 370px;height:370px; object-fit: cover;" alt=""></a>
										<a href="{{ url('pengumuman-page/'.$p->id)}}"><h4>{{ $p->judulpeng}}</h4></a>
										<!-- <p>{{ $p->deskripsipeng}}</p> -->
										<p>{{ Str::limit($p->deskripsipeng, 45)}}</p>
										<div class="buttons">
											<div class="accent-button">
												<a href="{{ url('pengumuman-page/'.$p->id)}}">Continue Reading<i class="fa fa-arrow-right"></i></a>
											</div>
										</div>
                                    </div>
